...
def main():
	cfiles = "comp_lib9.c compacc2e.c mshowbest.c build_ares.c re_getlib.c mshowalign2.c htime.c apam.c doinit.c initfa.c scaleswn.c karlin.c dropnfa.c wm_align.c cal_cons2.c nmgetlib.c mmgetaa.c c_dispn.c ncbl2_mlib.c lib_sel.c mrandom.c url_subs.c"
	c = new_compiler()
